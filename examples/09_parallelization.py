...
business_idea = "An AI-powered meal planning app that generates grocery lists and suggests recipes based on dietary restrictions and local store sales"

analysis_tasks = [
    # Market perspective
    (
        "You are a market analyst. In 3-4 sentences, evaluate the market opportunity for this business idea. "
        "Consider target audience size and competition:\n\n{context}"
    ),
    # Technical feasibility
    (
        "You are a CTO. In 3-4 sentences, evaluate the technical feasibility of this business idea. "
        "Consider what APIs and data sources are needed:\n\n{context}"
    ),
    # Revenue model
    (
        "You are a business strategist. In 3-4 sentences, propose the best revenue model for this business idea. "
        "Consider pricing tiers and monetization:\n\n{context}"
    ),
]
